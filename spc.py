...
button_stone=Button(w,width=18,height=3,text="Stone",font=("algerian",18,"bold"),bg="silver",fg="red",relief="sunken",command=lambda:input("stone")).grid(row=4,column=1)
button_paper=Button(w,width=18,height=3,text="Paper",font=("algerian",18,"bold"),bg="silver",fg="red",relief="sunken",command=lambda:input("paper")).grid(row=4,column=2)
button_scissor=Button(w,width=18,height=3,text="Scissor",font=("algerian",18,"bold"),bg="silver",fg="red",relief="sunken",command=lambda:input("scissor")).grid(row=4,column=3)
